...
class OfflineModelService {
  ...
  List<double> _normalizeHotspots(List<double> values) {
    ...
    final upper =
        active[upperIndex] <= lower ? active.last : active[upperIndex];
